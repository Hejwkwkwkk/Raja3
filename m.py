...
TOKEN = '7630314402:AAE37dJ9bTZsk7KO2SwPjGWCBp1CyGU2UJc'
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/RRAJARAJ_04")
            markup.add(button1)
            markup.add(button2)
        else:
